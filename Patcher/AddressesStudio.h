...
constexpr auto ADDRESS_INSTANCE_RAISEPROPERTYCHANGED = 0x005FC870;
...
constexpr auto ADDRESS_FRM_SSAO_VRAM_JUMP = 0x005E0C5F;

constexpr auto ADDRESS_NETWORKSETTINGS_SETDATASENDRATE = 0x00531C80;
constexpr auto ADDRESS_NETWORKSETTINGS_SETPHYSICSSENDRATE = 0x00531CF0;
constexpr auto ADDRESS_NETWORKSETTINGS_SETRECEIVERATE = 0x00531D60;

constexpr auto ADDRESS_DATASENDRATE_PROP_DESC = 0x00E5E1A0;
constexpr auto ADDRESS_PHYSICSSENDRATE_PROP_DESC = 0x00E5E020;
constexpr auto ADDRESS_RECEIVERATE_PROP_DESC = 0x00E5DE78;

constexpr auto ADDRESS_TEXTBOX_CAPTUREFOCUS_SECURITY = 0x00A918E0;

constexpr auto ADDRESS_BRICKCOLOR_CONSTRUCTOR = 0x0073ED00;

constexpr auto ADDRESS_BITSTREAM_READBITS = 0x00546680;
constexpr auto ADDRESS_BITSTREAM_WRITEBITS = 0x00546CA0;
constexpr auto ADDRESS_BITSTREAM_DESERIALIZE_BRICKCOLOR = 0x00541D50;
constexpr auto ADDRESS_BITSTREAM_SERIALIZE_BRICKCOLOR = 0x00541940;

constexpr auto ADDRESS_NETWORK_SERIALIZE_BRICKCOLOR = 0x00544270;

constexpr auto ADDRESS_GET_PROPERTY_BRICKCOLOR_VALUE = 0x00543D10;
